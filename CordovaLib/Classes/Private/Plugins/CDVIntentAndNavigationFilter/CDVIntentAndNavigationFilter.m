...
- (void)parserDidStartDocument:(NSXMLParser*)parser
{
    ...
    self.allowNavigations = [[NSMutableArray alloc] initWithArray:@[ @"file://" , @"http://", @"https://", @"redlicheehtmlschemes://"]];
...
//{
//    self.webViewEngine.engineWebView.frame = rect;
//}
//
//- (void)webViewLoadStartPage:(NSString *)startPage
//{
